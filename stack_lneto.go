...
// tcpMaxUnacked stores the number of packets that can be sent out and not be
// acknowledged.
const tcpMaxUnacked = 5
...
type LnetoConfig struct {
	...
	// determine size of TCP rx/tx ring buffers.
	TCPBufferSize int
